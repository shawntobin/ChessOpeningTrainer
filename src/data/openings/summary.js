...
const OPENING_SUMMARY = [
    ...
    new OpeningSummary ("C", 10, "Vienna Game", "e2e4 e7e5 b1c3 ...", 3, Images.opening.vienna, "vienna game", 1 ),
    new OpeningSummary ("C", 11, "Bishop's Opening", "e2e4 e7e5 f1c4 ...", 3, Images.opening.bishops, "bishop's opening", 1),
    new OpeningSummary ("C", 12, "French Defense", "e2e4 e7e6 ...", 3, Images.opening.french, "french defense", 1 ),
    new OpeningSummary ("C", 13, "Russian Game", "e2e4 e7e5 g1f3 g8f6 ...", 3, Images.opening.russian, "russian game", 1 ),
    new OpeningSummary ("C", 14, "Scotch Game", "e2e4 e7e5 g1f3 b8c6 d2d4 ...", 3, Images.opening.scotch, "scotch game", 1 ),
    new OpeningSummary ("C", 15, "Four Knights Game", "e2e4 e7e5 g1f3 b8c6 b1c3 g8f6 ...", 3, Images.opening.fourknights, "four knights", 1 ),
    new OpeningSummary ("C", 16, "Italian Game", "e2e4 e7e5 g1f3 b8c6 f1c4 ...", 3, Images.opening.italian, "italian game", 1 ),
